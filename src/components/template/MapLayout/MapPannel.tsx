...
export default function MapPanel({
  ...
  return (
    ...
    >
      {/* 지도 유형 */}
      <h3 className="text-lg font-semibold text-gray-700 mb-4">지도 유형</h3>
      <div className="space-y-2">
        <div className="flex space-x-2">
          ...
          <button
            ...
            onClick={() => handleChangeMapType(naverMaps.MapTypeId.SATELLITE)}
          >
          ...
          >
            <img className="w-full rounded-xl" src={topographic} alt="logo" />
            <div className="absolute inset-0 flex items-center justify-center text-black font-bold text-base">
              지형지도
            </div>
          </button>
